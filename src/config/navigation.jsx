...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'header-footer', name: 'common.headerFooter', icon: 'LayoutTemplate', path: '/header-footer', description: 'nav.headerFooterDesc', keywords: '页眉,页脚,页眉页脚,页眉文字,页脚文字,logo,header,footer' },
      { id: 'background', name: 'common.background', icon: 'Palette', path: '/background', description: 'nav.backgroundDesc', keywords: '背景,背景色,背景图片,护眼色,background' },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'pdf-to-ppt', name: 'common.pdfToPpt', icon: 'Presentation', path: '/pdf-to-ppt', description: 'nav.pdfToPptDesc', keywords: '转ppt,ppt,pptx,演示文稿,幻灯片,pdf2ppt,powerpoint' },
  ...
  },
  {
    ...
    tools: [
      ...
      { id: 'grayscale', name: 'common.grayscale', icon: 'Contrast', path: '/grayscale', description: 'nav.grayscaleDesc', keywords: '灰度,黑白,黑白化,灰度化,打印省墨,grayscale,bw' },
